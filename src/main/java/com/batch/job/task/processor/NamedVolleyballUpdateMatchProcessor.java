...
//    }
//
//    private void parseBaseData( JSONObject matchObject , VolleyballModel aTeamModel , VolleyballModel bTeamModel) throws JSONException, ParseException {
//
...
//    }
//
//    private void parsePitcherAndOdd( JSONObject matchObject , VolleyballModel aTeamModel , VolleyballModel bTeamModel) throws JSONException {
//
//        JSONObject homeTeam = matchObject.getJSONObject("teams").getJSONObject("home");
//        JSONObject awayTeam = matchObject.getJSONObject("teams").getJSONObject("away");
//
...
//    }
//
//    private void parseScore( JSONObject matchObject , VolleyballModel aTeamModel , VolleyballModel bTeamModel) throws JSONException{
...
//    }
//
//    private void parseInningHandiUnover( JSONObject matchObject , VolleyballModel aTeamModel , VolleyballModel bTeamModel) throws Exception{
//        if (aTeamModel.getHandiCap() == 0) {
...
//    }
//
//    private void parseSpecial( JSONObject matchObject , VolleyballModel aTeamModel , VolleyballModel bTeamModel) throws JSONException {
...
//    }
//
//    private boolean validationData(VolleyballModel item){
//
